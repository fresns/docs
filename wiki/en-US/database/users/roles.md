...
| type | tinyint *UNSIGNED* | Role Type | 3 | NO | 1.Administrative: Administrator, Moderator<br>2.System Settings: Pending Users, Banned Users<br>3.User Operations: Regular Member, Premium Member |
| name | varchar(128) | Role Name |  | NO | **Multilingual** |
...
## Introduction to Role Types

- In the User Configuration page of the backend, the Default User Role and Interdiction User Role are not selected and cannot be used as configuration items.
...
[
    ...
    {
        "permKey": "post_email_verify", // Post requirements - Email
        "permValue": false, // false=Not required; true=Required
        "isCustom": false
    },
    {
        "permKey": "post_phone_verify", // Post requirements - Phone
        "permValue": false, // false=Not required; true=Required
        "isCustom": false
    },
    {
        "permKey": "post_real_name_verify", // Post requirements - Real name verification
        "permValue": false, // false=Not required; true=Required
        "isCustom": false
    },
    {
    ...
    {
        "permKey": "comment_email_verify", // Comment requirements - Email
        "permValue": false, // false=Not required; true=Required
        "isCustom": false
    },
    {
        "permKey": "comment_phone_verify", // Comment requirements - Phone
        "permValue": false, // false=Not required; true=Required
        "isCustom": false
    },
    {
        "permKey": "comment_real_name_verify", // Comment requirements - Real name verification
        "permValue": false, // false=Not required; true=Required
        "isCustom": false
    },
    {
    ...
    {
        "permKey": "post_editor_image_upload_number", // Number of images to upload
    ...
    {
        "permKey": "post_editor_video_upload_number", // Number of videos to upload
    ...
    {
        "permKey": "post_editor_audio_upload_number", // Number of audios to upload
    ...
    {
        "permKey": "post_editor_document_upload_number", // Number of documents to upload
    ...
    {
        "permKey": "comment_editor_image_upload_number", // Number of images to upload
        "permValue": 9, // Number of units
        "isCustom": false
    },
    {
    ...
    {
        "permKey": "comment_editor_video_upload_number", // Number of videos to upload
        "permValue": 1, // Number of units
        "isCustom": false
    },
    {
    ...
    {
        "permKey": "comment_editor_audio_upload_number", // Number of audios to upload
        "permValue": 2, // Number of units
        "isCustom": false
    },
    {
    ...
    {
        "permKey": "comment_editor_document_upload_number", // Number of documents to upload
        "permValue": 10, // Number of units
        "isCustom": false
    },
