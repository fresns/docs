...
| --- | --- | --- | --- |
| interactiveType | String | **required** | 标记行为 `like`,`dislike`,`follow`,`block` |
...
- Whether you have the right to operate, configure portal `operation > interactive configuration > interactive behavior settings`. The configuration values are in the `interactive` parameters of the corresponding content interface.
