...
| 数据库和版本<br>`任选一种` | MySQL `5.7 ~ 8.x`<br>MariaDB `10.3 ~ 11.x`<br>PostgreSQL `11.x ~ 16.x`<br>SQL Server `2016(13.x) ~ 2022(16.x)`<br>SQLite `3.9` 或更高版本 |
...
::: tip 方式 1: 手动下载安装包
- [下载 Fresns v2.21.1](https://app.fresns.org/latest.zip)
:::
