...
$bodyInfo = [
    ...
    'imageHandlePosition' => $imageHandlePosition, // disk=local 专用，支持 start, end, name-start, name-end
...
[
    {
        ...
        "path": "存储到 files > path",
        "imageHandlePosition": "存储到 files > image_handle_position", // disk=local 专用，支持 start, end, name-start, name-end
