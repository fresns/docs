...
const members = [
    {
        avatar: 'https://images.fresns.com/docs/avatars/jevan-tang.jpg',
        name: 'Jevan Tang',
        title: 'Creator',
        links: [
            {
    ...
    {
        avatar: 'https://images.fresns.com/docs/avatars/mouyong.jpg',
        name: 'Yong Mou',
        title: 'Developer',
        links: [
    ...
    {
        avatar: 'https://images.fresns.com/docs/avatars/tracy-yuan.jpg',
        name: 'Tracy Yuan',
        title: 'Tester',
        links: [
