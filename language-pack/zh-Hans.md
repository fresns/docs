...
```json
{
    ...
    "accountType": "账号类型",
    "accountRegister": "注册",
    "accountRegisterError": "该注册通道已关闭，本页面无法注册",
    "accountLogin": "登录",
    ...
    "settingDialogAll": "允许所有用户",
    "settingDialogMyFollow": "仅允许我关注的用户",
    "settingDialogMyFollowAndVerified": "我关注的用户和已认证的用户",
