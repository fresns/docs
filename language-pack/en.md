...
```json
{
    ...
    "settingDialogAll": "Allow all users",
    "settingDialogMyFollow": "Only users that I am allowed to follow",
    "settingDialogMyFollowAndVerified": "users I follow and users I have certified",
