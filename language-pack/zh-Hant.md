...
```json
{
    ...
    "accountRegister": "註冊",
    "accountLogin": "登入",
    "accountLoginGoTo": "前往登入",
    "accountLoginByPassword": "密碼登入",
    "accountLoginByCode": "驗證碼登入",
    "accountLoginByConnects": "快速登入",
    "accountConnectEmpty": "未查詢到賬號關聯信息",
    "accountConnectLinked": "我有賬號，綁定關聯",
    "accountConnectLinkedTip": "請先使用「密碼」或者「驗證碼」登入賬號，登入後在賬號設置中綁定關聯。",
    ...
    "accountPoliciesCheck": "已閱讀並同意",
    "accountPoliciesAuthTip": "功能授權提醒",
    "accountPoliciesAuthDesc": "在您使用該功能前，請您認真閱讀《服務條款》和《隱私政策》，並點擊“同意授權”以表示您的充分知悉、理解及同意。",
    ...
    "settingCheckError": "操作驗證失敗，請先透過驗證再操作",
    ...
    "settingAccountConnect": "關聯",
    "settingAccountDisconnect": "解除",
    "admin": "管理員",
    "groupAdmin": "社團管理員",
    ...
    "editorDraftCreate": "創建新草稿",
    "editorNoSelectGroup": "未選擇",
    "editorNoGroup": "不發到任何社團",
    ...
    "editorReadConfigTitle": "權限信息",
    "editorReadConfigRoleName": "指定用戶角色可訪問",
    "editorReadConfigUserName": "指定用戶可訪問",
    "editorReadConfigPercentageName": "可試讀前內容比例",
    "editorReadConfigButtonName": "獲取閱讀權限按鈕文字",
    "editorCommentButtonTitle": "留言按鈕信息",
    "editorCommentButtonName": "按鈕名稱",
    "editorUserListTitle": "特定成員配置",
    "editorUserListName": "特定成員名稱",
    "contentReviewPending": "內容審查中",
    "contentReviewRejected": "內容審查拒絕",
    "contentLoginError": "需要登入後才能查看",
    "contentAllList": "所有",
    "contentNewList": "最新",
    "contentHotList": "熱門",
    "contentBrowse": "瀏覽",
