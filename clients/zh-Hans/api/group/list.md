...
| orderType | String | NO | 排序类型 `view`,`like`,`dislike`,`follow`,`block`,`post`,`postDigest`,`createdTime`,`createdTime`,`createdTime`,`lastPostTime`,`lastCommentTime`,`random`,`sortOrder`<br>默认 `sortOrder` |
