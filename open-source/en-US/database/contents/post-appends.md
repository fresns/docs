...
| read_plugin_fskey | varchar(64) | Read permission - handling plugin |  | YES | Related field [apps->fskey](../apps/apps.md) |
...
| user_list_plugin_fskey | varchar(64) | Specific user source plugin |  | YES | Related field [apps->fskey](../apps/apps.md) |
...
| comment_btn_plugin_fskey | varchar(64) | Comment extended button - handling plugin |  | YES | Related field [apps->fskey](../apps/apps.md) |
