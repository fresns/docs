      ...
      <div class="menus">
        <div class="FsMenu">
          ...
          <div class="FsMenuLink">
            <a class="link" href="/zh-Hans/oauth/">OAuth 应用</a>
          </div>
          <div class="FsMenuLink">
            <a class="link" href="/zh-Hans/cloud/">云服务应用</a>
          </div>
          <div class="FsMenuLink">
            <a class="link active" href="/zh-Hans/open-source/">开源扩展</a>
          </div>
          <div class="FsMenuLink">
            <a class="link" href="/zh-Hans/clients/">客户端</a>
          </div>
          <!-- items end -->
        </div>
      </div>
